package testcore.pages.Landing.Steps;

import agent.IAgent;
import central.Configuration;
import org.apache.commons.lang3.NotImplementedException;
import org.testng.asserts.SoftAssert;
import testcore.pages.androidNative.Landing.Steps.AndroidNativeLandingPageSteps;
import testcore.pages.androidNative.LandingPage;
import java.util.Map;

public class LandingPageSteps extends LandingPage {

    public LandingPageSteps(Configuration conf, IAgent agent, Map<String, String> testData) throws Exception {
        super(conf, agent, testData);
    }

    public LandingPageSteps createInstance() throws Exception {
        LandingPageSteps derivedLandingPageSteps;
        switch (getPlatform()) {
            case ANDROID:
                derivedLandingPageSteps = new LandingPageSteps(getConfig(), getAgent(), getTestData());
                break;
            default:
                throw new NotImplementedException("Invalid platform - please check the platform argument: " + getPlatform().toString());
        }
        return derivedLandingPageSteps;
    }
    ...
    public LandingPageSteps validateUserNavigatedToAddGoalPage(SoftAssert softAssert) throws Exception {
        return null;
    }
