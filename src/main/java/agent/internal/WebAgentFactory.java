...
//			driver.get(getProperty("app_browser_url", config));
	...
	private static void setPropertyByOS(DesktopBrowser browser) throws Exception {
		...
		case "OS_WINDOWS":
			...
			case FIREFOX:
				...
				break;
			case IE:
				System.setProperty("webdriver.ie.bin", System.getProperty("browser_bin_path"));
				System.setProperty("webdriver.ie.driver", System.getProperty("browser_driver_path"));
				break;
			case EDGE:
				System.setProperty("webdriver.edge.driver", System.getProperty("browser_driver_path"));
				break;
			default:
				break;
			}
	...
	private static DesiredCapabilities getCapability(DesktopBrowser browser) throws Exception {
		...
		case CHROME:
			...
			if (System.getProperty("browser_bin_path") != null) {
