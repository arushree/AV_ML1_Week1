...
public abstract class Control implements IControl {
	...
	public Control(String name, IPage page, List<WebElement> elements) {
		this.setName(name);
		this.setPage(page);
		this.setAgent(page.getAgent());
		this.setPlatform(page.getPlatform());
		this.setRawWebElements(elements);
	}
	...
	protected List<WebElement> getRawWebElements() {
		return webElements;
	}
	...
	private void setRawWebElements(List<WebElement> wrappedElement) {
		this.webElements = wrappedElement;
	}
