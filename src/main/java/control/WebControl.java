...
public class WebControl extends Control {
    ...
    public WebControl(String name, IPage page, List<WebElement> elements) {
        super(name, page, elements);
    }
    ...
    @Override
    public List<WebElement> thisControlElements() throws Exception {
        return this.getRawWebElements();
    }

    @Override
    public void selectValue(String gender) throws Exception {
    }
